/* Generated by Cython 0.19 on Fri Apr 18 16:20:24 2014 */
...
static PyObject *__pyx_pf_7mixtape_25_DiagonalGaussianHMMEstep_doDiagonalGaussianHMMEstep(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED int __pyx_v_numStates, CYTHON_UNUSED PyArrayObject *__pyx_v_transmat, CYTHON_UNUSED PyArrayObject *__pyx_v_startProb, CYTHON_UNUSED int __pyx_v_numFeatures, CYTHON_UNUSED PyArrayObject *__pyx_v_means, CYTHON_UNUSED PyArrayObject *__pyx_v_variances); /* proto */
...
static PyObject *__pyx_pw_7mixtape_25_DiagonalGaussianHMMEstep_1doDiagonalGaussianHMMEstep(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  CYTHON_UNUSED int __pyx_v_numStates;
  CYTHON_UNUSED PyArrayObject *__pyx_v_transmat = 0;
  CYTHON_UNUSED PyArrayObject *__pyx_v_startProb = 0;
  CYTHON_UNUSED int __pyx_v_numFeatures;
  CYTHON_UNUSED PyArrayObject *__pyx_v_means = 0;
  CYTHON_UNUSED PyArrayObject *__pyx_v_variances = 0;
  int __pyx_lineno = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__numStates,&__pyx_n_s__transmat,&__pyx_n_s__startProb,&__pyx_n_s__numFeatures,&__pyx_n_s__means,&__pyx_n_s__variances,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__transmat)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("doDiagonalGaussianHMMEstep", 1, 6, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__startProb)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("doDiagonalGaussianHMMEstep", 1, 6, 6, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__numFeatures)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("doDiagonalGaussianHMMEstep", 1, 6, 6, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__means)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("doDiagonalGaussianHMMEstep", 1, 6, 6, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__variances)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("doDiagonalGaussianHMMEstep", 1, 6, 6, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "doDiagonalGaussianHMMEstep") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_numStates = __Pyx_PyInt_AsInt(values[0]); if (unlikely((__pyx_v_numStates == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_transmat = ((PyArrayObject *)values[1]);
    __pyx_v_startProb = ((PyArrayObject *)values[2]);
    __pyx_v_numFeatures = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_numFeatures == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_means = ((PyArrayObject *)values[4]);
    __pyx_v_variances = ((PyArrayObject *)values[5]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("doDiagonalGaussianHMMEstep", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_transmat), __pyx_ptype_5numpy_ndarray, 0, "transmat", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_startProb), __pyx_ptype_5numpy_ndarray, 1, "startProb", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_means), __pyx_ptype_5numpy_ndarray, 1, "means", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_variances), __pyx_ptype_5numpy_ndarray, 1, "variances", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_7mixtape_25_DiagonalGaussianHMMEstep_doDiagonalGaussianHMMEstep(__pyx_self, __pyx_v_numStates, __pyx_v_transmat, __pyx_v_startProb, __pyx_v_numFeatures, __pyx_v_means, __pyx_v_variances);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
/* "estep/wrappers/DiagonalGaussianHMMEstep.pyx":21
 * 
 * 
...
static PyObject *__pyx_pf_7mixtape_25_DiagonalGaussianHMMEstep_doDiagonalGaussianHMMEstep(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED int __pyx_v_numStates, CYTHON_UNUSED PyArrayObject *__pyx_v_transmat, CYTHON_UNUSED PyArrayObject *__pyx_v_startProb, CYTHON_UNUSED int __pyx_v_numFeatures, CYTHON_UNUSED PyArrayObject *__pyx_v_means, CYTHON_UNUSED PyArrayObject *__pyx_v_variances) {
  ...
  __pyx_pybuffernd_variances.rcbuffer = &__pyx_pybuffer_variances;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_transmat.rcbuffer->pybuffer, (PyObject*)__pyx_v_transmat, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_startProb.rcbuffer->pybuffer, (PyObject*)__pyx_v_startProb, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_means.rcbuffer->pybuffer, (PyObject*)__pyx_v_means, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_variances.rcbuffer->pybuffer, (PyObject*)__pyx_v_variances, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("doDiagonalGaussianHMMEstep"), (PyCFunction)__pyx_pw_7mixtape_25_DiagonalGaussianHMMEstep_1doDiagonalGaussianHMMEstep, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
 ...
 */
  ...
  /* "estep/wrappers/DiagonalGaussianHMMEstep.pyx":3
 * import numpy as np
 * cimport numpy as np
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
